...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $topTrans=DB::select('select count(c.id) total,c.id, c.name,c.address from reservations r right JOIN cafes c on r.cafe_id=c.id where c.status=1 GROUP by c.id,c.name,c.address limit 5 ');
        //return $topTrans;
