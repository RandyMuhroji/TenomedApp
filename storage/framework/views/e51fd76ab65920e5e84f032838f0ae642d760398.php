      ...
      <div class="col-md-3 left_col menu_fixed">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title"><i class="fa fa-paw"></i> <span><?php echo app('translator')->get('general.app.name'); ?></span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu menu_fixed">
              <div class="menu_section">
                  ...
                  <ul class="nav side-menu">
                      <li><a href="<?php echo e(route('admin')); ?>"><i class="fa fa-home"></i> Dashboard </a></li>
                      <li><a href="<?php echo e(route('cafes.index')); ?>"><i class="fa fa-coffee"></i> Cafes </a></li>
                      <li><a href="<?php echo e(route('users.index')); ?>"><i class="fa fa-users"></i> <?php echo app('translator')->get('general.nav.users'); ?> </a></li>
                      <li><a href="<?php echo e(route('sponsors.index')); ?>"><i class="fa fa-users"></i>Sponsors </a></li>
