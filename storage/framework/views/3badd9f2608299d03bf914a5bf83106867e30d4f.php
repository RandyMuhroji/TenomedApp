...
<div class="cards-simple-wrapper">
    ...
    <div class="post">
        <div class="post-image">
            <img src="<?php echo e(asset('')); ?>assets/img/tmp/product-6.jpg" alt="">
    ...
    <div class="post">
        <div class="post-image">
            <img src="<?php echo e(asset('')); ?>assets/img/tmp/product-8.jpg" alt="">
            <a class="read-more" href="blog-detail-right-sidebar.html">View</a>
        </div><!-- /.post-image -->
    ...
    <div class="post">
        <div class="post-image">
            <img src="<?php echo e(asset('')); ?>assets/img/tmp/product-10.jpg" alt="">
            <a class="read-more" href="blog-detail-right-sidebar.html">View</a>
        </div><!-- /.post-image -->
...
<div class="cards-wrapper">
    <div class="row">
        <div class="col-sm-8">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card" data-background-image="<?php echo e(asset('')); ?>assets/img/tmp/product-7.jpg">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card" data-background-image="<?php echo e(asset('')); ?>assets/img/tmp/product-4.jpg">
                        <div class="card-label">
                ...
                <div class="col-sm-6">
                    <div class="card" data-background-image="<?php echo e(asset('')); ?>assets/img/tmp/product-2.jpg">
                        <div class="card-label">
        ...
        <div class="col-sm-4">
            <div class="card card-tall" data-background-image="<?php echo e(asset('')); ?>assets/img/tmp/product-1.jpg">
                <div class="card-label">
                    <a href="listing-detail.html">Vacation</a>
                </div><!-- /.card-label -->
...
<div class="row">
    <div class="col-sm-6">
        <div class="testimonial">
            <div class="testimonial-image">
                <img src="<?php echo e(asset('')); ?>assets/img/tmp/agent-1.jpg" alt="">
        ...
        <div class="testimonial">
            <div class="testimonial-image">
                <img src="<?php echo e(asset('')); ?>assets/img/tmp/agent-2.jpg" alt="">
            </div><!-- /.testimonial-image -->
        ...
        <div class="testimonial last">
            <div class="testimonial-image">
                <img src="<?php echo e(asset('')); ?>assets/img/tmp/agent-3.jpg" alt="">
            </div><!-- /.testimonial-image -->
    ...
    <div class="col-sm-6">
        <div class="testimonial">
            <div class="testimonial-image">
                <img src="<?php echo e(asset('')); ?>assets/img/tmp/agent-4.jpg" alt="">
            </div><!-- /.testimonial-image -->
        ...
        <div class="testimonial last">
            <div class="testimonial-image">
                <img src="<?php echo e(asset('')); ?>assets/img/tmp/agent-5.jpg" alt="">
            </div><!-- /.testimonial-image -->
