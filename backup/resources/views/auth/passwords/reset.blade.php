...
<head>
    ...
    <title>Tenomed Admin | Password Reset</title>
                ...
                <section class="login_content">
                    ...
                    <form role="form" method="post" action="{{ route('password.reset') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            @endif
                            <input type="text" class="form-control" id="email" name="email" placeholder="@lang('general.passwords.email')" required autofocus/>
                        </div>
