  	...
  	<div class="bs-example" data-example-id="simple-jumbotron">
	    ...
	    <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <span class="count_bottom"> This mounth</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="x_panel tile fixed_height_320">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      <li><span style="width: 150px;">50</span> <i class="fa fa-user"></i><a href="#">5 Stars</a>
                      </li>
                      <li><span style="width: 30px;">34</span> <i class="fa fa-user"></i><a href="#">4 Stars</a>
                      </li>
                      <li><span style="width: 30px;">12</span> <i class="fa fa-user"></i><a href="#">3 Stars</a> </li>
                      <li><span style="width: 30px;">22</span> <i class="fa fa-user"></i><a href="#">2 Stars</a>
                      </li>
                      <li><span style="width: 30px;">5</span> <i class="fa fa-user"></i><a href="#">1 Stars</a> </li>
                      </li>
                    </ul>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="goal-wrapper">
                          <span id="gauge-text" class="gauge-value pull-left">2</span>
