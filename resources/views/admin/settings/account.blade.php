        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <br />
                    <form method="post" action="/admin/settings/account" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
...
<div id="changePassword" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form id="frmChangePassword" method="post" action="{{ route('change_password_admin') }}" data-parsley-validate class="form-horizontal form-label-left">
