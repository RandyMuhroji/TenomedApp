...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Create Cafe <a href="{{route('users.index')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> @lang('general.nav.back') </a></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
...
@section('js')
    <script src="{{asset('tenomed/build/js/custom.min.js')}}"></script>
@stop

@section('css')
    <link href="{{asset('tenomed/build/css/custom.min.css')}}" rel="stylesheet">
@stop