                ...
                <div class="content">
                  <form method="post" id="frmBooking" action="/saveBooking/{{ $detail->id }}?id={{Auth::user()->id}}">
                    <div class="page-title">
                      ...
                      <h1>Booking Form {{$detail->name}} </h1><br>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="book_tanggal" onchange="getHari(jQuery('#datepicker').val());" id="datepicker" placeholder="Date" required=""  >
